        ...
        <div class="mt-5 p-5" style="background-color: rgba(212, 212, 212, 0.268); width: 1000px; border-radius:5px; box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.5);margin-left:100px;">
            ...
            <form method="post" action="{{ route('admin.setting') }}">
                ...
                <div class="mb-3">
                    ...
                    <input name="name" type="text" value="{{ old('name', $user->name) }}" class="form-control" id="nameInput" required>
                ...
                <div class="mb-3">
                    ...
                    <input name="email" type="email" value="{{ old('email', $user->email) }}" class="form-control" id="emailInput" >
                    {{-- input validation --}}
