                    ...
                    <form action="" method="post">
                        <div class="invoice-bg ">
                            <div class="d-flex justify-content-evenly mb-2">
                                ...
                                <div>
                                    <p>
                                        📨Ponta Negra Beach, State of Rio Grande do Norte,Brazil.
                                    </p>
                                </div>
                            </div>

                            <!-- <h6>Invoice id : # </h6> -->
                            <pre>Invoice Date : {{ \carbon\carbon::parse($booking->created_at)->format('d M, Y') }} </pre>
                    ...
                    <div class="profile-invoice-detail-bg bg-body-secondary">
                        ...
                        <div class="d-flex justify-content-around p-2">
                            ...
                            <span>
                                ...
                                @elseif ( $booking->reservation_status  == "Confirm")
