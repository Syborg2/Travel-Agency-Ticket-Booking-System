...
@section('content')
      ...
      {{-- Home Image --}}
        <img src="{{ asset('image/361.jpg') }}" height="750"  class="d-block w-100" style="margin-top: -120px"; alt="main image">
        {{-- Image Text --}}
            <div class="mainTextPosition text-center">
              <h5 class="mainTextSize">Explore Brazil at Your Own Place</h5>
              <p>Where Every Road Becomes Your Story</p>
            </div>


        <pre class="text-center fs-3 mt-3">Welcome To Brazil🙏</pre>
        ...
        <div class="container mt-5">
            {{-- <div class="d-flex justify-content-between">
                <div>
                    ...
                    <pre>Explore Brazil's Gems in a Day</pre>
                </div>
                <div>
                            ...
                            <div class="card d-inline-flex p-1" style="width: 18rem;">
                                <img src="{{ asset('image/cart_image1.png') }}" class="card-img-top object-fit-fill" alt="...">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Explore the Rich Heritage of Rio de Janeiro with a Visit through a cable car</p>
                                    </div>
        ...
        <div class="container-fluid mt-5 section-bg-color-home">
            <div class="row ">
                <div class="col m-5">
                    {{-- <pre>Elevate Your Brazil Adventure</pre> --}}
                    <h2>Discover the Brazil Tours Difference</h2>
                    <p>At Brazil Tours Travels, we go beyond being just a travel agency;
                        we're your gateway to an extraordinary Brazil experience. Here's why choosing us will redefine your journey
                    </p>
                    ...
                    <ol>
                        ...
                        <li>
                            <div class="alignment">
                                ...
                                <p>Immerse yourself in Brazil's culture. Meet locals, savor authentic cuisine, and <br/>
        ...
        {{-- youtube video --}}
        <div class="m-5">
            <iframe width="1150" height="650" src="https://youtube.com/embed/gYy1RITRN9s?si=6CP_ni95zKSWPIXC"
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <div class="col-7 review-bg p-4 text-justify">
                            ...
                            <q class="font-monospace">Booking a tour with Brazil Travels was the best decision I made for my Brazil adventure.
                            ...
                            <hr/>
                            <p class="font-monospace">Andrew <br/> Canada</p>
                        </div>
                      </div>
                      ...
                      <div class="carousel-item">
                        <div class="col-7 review-bg p-4 text-justify">
                            {{-- <p class="fw-bold">What Our Clients Have to Say</p> --}}
                            <q class="font-monospace">Booking a tour with Ceylonia Travels was the best decision I made for my Brazil adventure.
                                The attention to detail and personalized experience made every moment memorable.
                                From the ancient wonders to the scenic train rides, every day was a new discovery.
                            </q>
                            <hr/>
                            <p class="font-monospace">Amal <br/> India</p>
                        </div>
                      </div>
                    </div>
