...
@section('content')
      ...
      <div class="overflow-x-scroll">
        ...
        <div class="row mt-4">
          ...
          <div class="col-5">
            ...
            <br><br><br><br><br><br>
            <div>
           <center><img src="{{ asset('image/upi.png') }}" width="200px" alt ="upi"> </center> <br>
           <center><h3>Pay to this QR code </h3></center>
            </div>
          </div>
        </div>
      ...
      <script>
        ...
        function updateTotalPrice() {
            ...
            const totalPrice =  (children * perChildFee) + (adults * perAdultFee);
