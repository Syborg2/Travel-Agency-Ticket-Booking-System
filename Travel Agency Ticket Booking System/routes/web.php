...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/admin/setting', [AdminController::class, 'editPassword'])->name('admin.setting');
    Route::patch('/admin/setting', [AdminController::class, 'update'])->name('admin.setting');
});
